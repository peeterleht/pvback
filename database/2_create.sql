...
ALTER TABLE company ADD CONSTRAINT company_subscription_type
...
ALTER TABLE company_user ADD CONSTRAINT company_user_project_role
...
ALTER TABLE process ADD CONSTRAINT process_project_role
    FOREIGN KEY (project_role_id)
        REFERENCES project_role (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE process ADD CONSTRAINT project_part_project
...
ALTER TABLE project_user ADD CONSTRAINT project_user_project_role
    FOREIGN KEY (project_role_id)
        REFERENCES project_role (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE time_log ADD CONSTRAINT time_log_project
    FOREIGN KEY (project_id)
        REFERENCES project (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE time_log ADD CONSTRAINT time_log_user
    FOREIGN KEY (user_id)
        REFERENCES "user" (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
